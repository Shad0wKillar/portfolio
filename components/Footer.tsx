      ...
      <div className="flex justify-center space-x-12 mb-4">
        {socialLinks.map((social) => (
          <a
            ...
            href={social.link}
            title={social.title}
            className="transform scale-150 md:scale-125 link-outline flex items-center justify-center"
          >
            {social.svg}
          </a>
        ))}
...
const socialLinks = [
  {
    id: 1,
    title: "Abdullah Mubarak's Github Profile",
    link: "https://github.com/Shad0wKillar",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    id: 2,
    title: "Abdullah Mubarak's Hugging Face Profile",
    link: "https://huggingface.co/Shad0wKillar",
    svg: (
      <img
        src="/hf_logo.svg"
        alt="Hugging Face Logo"
        className="w-6 h-6 object-contain dark:brightness-150 transition-all hover:opacity-80"
      />
    ),
  },
  {
    id: 3,
    title: "Abdullah Mubarak's LinkedIn Profile",
    link: "https://www.linkedin.com/in/abdullah-mubarak-258197265/",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    id: 4,
    title: "Check Abdullah Mubarak on Dev.to",
    link: "https://dev.to/shad0wkillar",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
