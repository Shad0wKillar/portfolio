...
const AppHead: React.FC<Props> = ({
  ...
  let appOgImage = `${process.env.NEXT_PUBLIC_URL}/shad0w-dev-og-new.png`;
  let appOgImageAlt = "Shad0wKillar's Portfolio";
