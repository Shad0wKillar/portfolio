...
import shad0w from "../public/shad0w-illustration.webp";
...
const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      <span
        aria-hidden="true"
        className="bg-text absolute top-0 rotate-12 text-gray-100 dark:text-[#1f2e3a] text-9xl scale-150 tracking-wide font-bold select-none pointer-events-none text-center z-0"
      >
        PASSIONATE PROGRAMMER FREELANCER AI-RESEARCH DEVELOPER
      </span>
      ...
      <div className="image-animation z-10 select-none mt-0 xs:mt-6 sm:mt-14 lg:mt-0 px-0 mx-auto lg:p-0 lg:basis-1/3">
        <div className="relative w-72 md:w-80 h-80 flex items-center mx-auto">
          <div className="absolute pointer-events-none scale-70 xs:scale-75 mx-auto">
            <Image
              src={shad0w}
              width={1177}
              height={1374}
              ...
              aria-label="Shad0w character illustration levitating with a Laptop"
              alt="Shad0w character illustration"
            />
          </div>
          <div className="laptop absolute top-14 sm:top-16 left-0 scale-[.80] xs:scale-[.85] pointer-events-none">
            <Image
              src={laptop}
              width={559}
              height={386}
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          <p className="mb-1">
            I am an AI Student and Developer with a focus on Computer Vision and
            Deep Learning architectures.
          </p>
          <p>
            I have experience working with CNNs and ViTs, moving beyond
            high-level implementation to understand the underlying mechanics
            found in modern research. Whether I am parsing latest papers or
            optimizing model performance, I bring a technical, research-oriented
