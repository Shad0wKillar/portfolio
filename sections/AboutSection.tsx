...
import shad0w from "../public/shad0w.webp";
...
const AboutSection: React.FC = () => {
  ...
  useScrollActive(sectionRef, "who am i?");

  return (
    <div
      ref={sectionRef}
      className="about-panel bg-white dark:bg-[#1B2731] relative overflow-hidden"
    >
      <section id="whoami" className="section relative z-10">
        <RoughNotationGroup>
          ...
          <div className="md:grid grid-rows-5 lg:grid-rows-6 grid-cols-5">
            ...
            <p className="col-start-1 col-end-3 row-start-4 row-end-6 lg:row-start-1 lg:row-end-2 lg:col-start-3 lg:col-end-6 lg:ml-8 lg:mt-auto about-intro">
              BSAI student at ITU Lahore with a specialized focus on Computer
              Vision and Explainable AI (XAI). Proficient in optimizing CNN and
              ViT-based models through advanced transfer learning and
              fine-tuning techniques. I am passionate about deconstructing
              complex architectures to understand their inner workings and
              improving model transparency through XAI.
            </p>
            ...
            <div
              ...
              ref={eduRef}
            >
              <p className="edu-bg my-4">Background and Milestones</p>
...
const educationInfo = [
  {
    ...
    subTitle: "Information Technology University | 2023 - 2027",
    list: [
      "Specializing in Computer Vision and Explainable AI (XAI).",
      "Implementing and optimizing CNN and ViT-based architectures.",
    ],
  },
  {
    id: 2,
    title: "Hackathons & Competitions",
    subTitle: "ITU & COMSATS",
    list: [
      "Competed in the COMSATS Hackathon to build AI-driven solutions.",
      "Participated in ITU Code Rush competitive programming events.",
    ],
  },
];
